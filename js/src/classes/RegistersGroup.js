...
const ModbusRegister = require('@/classes/ModbusRegister')
const ModbusRegisters = require('@/classes/ModbusRegisters')
const IskraRegister = require('@/classes/IskraRegister')
const IskraRegisters = require('@/classes/IskraRegisters')
